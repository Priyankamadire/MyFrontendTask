...
const ClgViewAssg = () => {
  ...
  <td>
  <NavLink to={`/stdresbyteach/${assignment.id}`}>
    <button className='btn-btn-danger'>View Results</button>
  </NavLink>
</td>
                  <td>
  <NavLink to={`/deleteassg/${assignment.id}`}>
